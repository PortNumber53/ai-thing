...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Personal blog exploring technology, design, and creativity",
    },
  ];
};
  ...
  return (
    <main className="container mx-auto px-4 py-12 flex-grow">
      <div className="max-w-3xl mx-auto">
        {/* Welcome Section */}
        <section className="bg-white rounded-lg shadow-md p-8 prose prose-lg">
          <h1 className="text-3xl font-bold mb-6">Welcome to My Website</h1>
          <p className="text-lg text-gray-600">
            I'm Maurício Otta, a software engineer passionate about building
            great user experiences. Explore my blog posts, check out my
            portfolio, or learn more about my professional experience.
          </p>
        </section>
